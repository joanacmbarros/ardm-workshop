...
> I just found the SAS results dataset corresponding to the analysis you did before! It was stored in a not-so-ideally-named folder and, unfortunately, I could not find the corresponding script to recreate the analysis. Please, plot these results and compare to your previous KM plots to confirm the results match.
